<script setup lang="ts">
  /**
   * Line-icon renderer for the admin panel. Icon identity is ported verbatim
   * from the PDFly Admin design (lucide-style, 24×24 stroke icons).
   */
  ...
  const svg = computed(
    () =>
      `<svg viewBox="0 0 24 24" width="${props.size}" height="${props.size}" fill="none" stroke="currentColor" stroke-width="${props.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" style="display:block">${inner.value}</svg>`,
  )
</script>
