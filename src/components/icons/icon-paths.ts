/**
 * Line-icon path set (lucide-style, 24×24 viewBox, stroke-based).
 * Ported from the PDFly design so icon identity is preserved exactly.
...
export const ICON_PATHS: Record<string, string> = {
  ...
  sparkles:
    '<path d="M9.94 14.34 8 20l-1.94-5.66L2 12l4.06-2.34L8 4l1.94 5.66L14 12z"/><path d="M18 4v4"/><path d="M20 6h-4"/>',
  'trending-up':
  ...
  'form-input':
    '<rect width="20" height="12" x="2" y="6" rx="2"/><path d="M6 12h.01"/><path d="M11 12h5"/>',
  'panel-top': '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/>',
  'list-ordered':
    '<line x1="10" x2="21" y1="6" y2="6"/><line x1="10" x2="21" y1="12" y2="12"/><line x1="10" x2="21" y1="18" y2="18"/><path d="M4 6h1v4"/><path d="M4 10h2"/><path d="M6 18H4c0-1 2-2 2-3s-1-1.4-2-1"/>',
  'move-vertical': '<path d="M12 2v20"/><path d="m8 6 4-4 4 4"/><path d="m8 18 4 4 4-4"/>',
  'file-output':
    '<path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M4 7V4a2 2 0 0 1 2-2h9l5 5v11a2 2 0 0 1-2 2h-4"/><path d="M2 15h10"/><path d="m9 18 3-3-3-3"/>',
  'file-down':
  ...
  stamp:
    '<path d="M5 22h14"/><path d="M19.27 13.73A2.5 2.5 0 0 0 17.5 13h-11A2.5 2.5 0 0 0 4 15.5V17a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-1.5c0-.66-.26-1.29-.73-1.77Z"/><path d="M14 13V8.5C14 7 15 7 15 5a3 3 0 0 0-6 0c0 2 1 2 1 3.5V13"/>',
  eraser:
  ...
  'file-signature':
    '<path d="M20 19.5v.5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h7l2 2"/><path d="M16 3.5a1.4 1.4 0 0 1 2 2L11 12l-3 1 1-3Z"/><path d="M2 21c1.4-1 2.8-1 4 0s2.6 1 4 0"/>',
  'scan-text':
  ...
  'move-up-right': '<path d="M13 5H19V11"/><path d="M19 5 5 19"/>',
  ...
  droplets:
    '<path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 4.24 7 2c-.29 2.24-1.14 4.83-2.29 6.06S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z"/><path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97"/>',
  ...
  'align-obj-left':
    '<path d="M3 2v20"/><rect x="7" y="4" width="13" height="6" rx="1.5"/><rect x="7" y="14" width="8" height="6" rx="1.5"/>',
  'align-obj-center':
    '<path d="M12 2v20"/><rect x="5" y="4" width="14" height="6" rx="1.5"/><rect x="8" y="14" width="8" height="6" rx="1.5"/>',
  'align-obj-right':
    '<path d="M21 2v20"/><rect x="4" y="4" width="13" height="6" rx="1.5"/><rect x="9" y="14" width="8" height="6" rx="1.5"/>',
  'align-obj-top':
    '<path d="M2 3h20"/><rect x="4" y="7" width="6" height="13" rx="1.5"/><rect x="14" y="7" width="6" height="8" rx="1.5"/>',
  'align-obj-middle':
    '<path d="M2 12h20"/><rect x="4" y="5" width="6" height="14" rx="1.5"/><rect x="14" y="8" width="6" height="8" rx="1.5"/>',
  'align-obj-bottom':
    '<path d="M2 21h20"/><rect x="4" y="4" width="6" height="13" rx="1.5"/><rect x="14" y="9" width="6" height="8" rx="1.5"/>',
  'distribute-h': '<path d="M4 22V2"/><path d="M20 22V2"/><rect x="9" y="7" width="6" height="10" rx="1.5"/>',
  'distribute-v': '<path d="M2 4h20"/><path d="M22 20H2"/><rect x="7" y="9" width="10" height="6" rx="1.5"/>',
  'bring-front':
